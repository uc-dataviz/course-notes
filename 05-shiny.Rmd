...
Download the necessary  files for the Shiny app lesson using `usethis::use_course("uc-cfss/shiny-demo")`.
...
```{r fig.cap = "Shiny Run App"}
include_graphics(here("images", "shiny-runapp.png"))
```
...
```{r fig.cap = "Shiny Stop App"}
include_graphics(here("images", "shiny-stopapp.png"))
```
...
```{r fig.cap = "Shiny layout"}
include_graphics(here("images", "shiny-layout.png"))
```
...
```{r fig.cap = "Shiny inputs"}
include_graphics(here("images", "shiny-inputs.png"))
```
...
```{r fig.cap = "Shiny add inputs"}
include_graphics(here("images", "shiny-addinputs.png"))
```
...
```{r fig.cap = "Shiny add plot"}
include_graphics(here("images", "shiny-addplot.png"))
```
...
```{r fig.cap = "Shiny App with Blank Plot"}
include_graphics(here("images", "shiny-nullinput.png"))
```
...
```{r fig.cap = "Shiny Publish"}
include_graphics(here("images", "shiny-publish.png"))
```
